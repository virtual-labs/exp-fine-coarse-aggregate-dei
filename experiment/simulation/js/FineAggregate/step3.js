...
function gif3e() {
  ...
  myTimeout = setTimeout(() => {
    ...
    document.getElementById("hii").style.visibility = "visible";
...
function gif3f() {
  ...
  myTimeout = setTimeout(() => {
    ...
    document.getElementById("hiii").style.visibility = "visible";
...
function gif3g() {
  document.getElementById("hiii").style.visibility = "hidden";
  ...
  myTimeout = setTimeout(() => {
    ...
    document.getElementById("hiiii").style.visibility = "visible";
...
function gif3h() {
  document.getElementById("hiiii").style.visibility = "hidden";
  ...
  myTimeout = setTimeout(() => {
    ...
    document.getElementById("hiiiii").style.visibility = "visible";
...
function gif3i() {
  document.getElementById("hiiiii").style.visibility = "hidden";
  ...
  myTimeout = setTimeout(() => {
    ...
    document.getElementById("insA").textContent = "Prepare 215 grams of sodium sulphate.";
  }, 5000);
}
